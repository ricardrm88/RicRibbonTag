#
#  Be sure to run `pod spec lint RicRibbonTag.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = "Ricard"
  # Or just: s.author    = "Ricard"
  # s.authors            = { "Ricard" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Ricard"
  ...
  s.source_files  = "RicRibbonTag", "RicRibbonTag/**/*.{swift}"
